...
<Frame>
  <img className="block dark:hidden" src="/images/links/composer-basic-light.png" alt="The new link composer" />
  <img className="hidden dark:block" src="/images/links/composer-basic-dark.png" alt="The new link composer" />
</Frame>
