...
<Steps>
  <Step title="Open the link composer">
    ...
    <Frame>
      <img className="block dark:hidden" src="/images/links/composer-open-light.png" alt="Link composer freshly opened on the Basic tab with the destination field focused" />
      <img className="hidden dark:block" src="/images/links/composer-open-dark.png" alt="Link composer freshly opened on the Basic tab with the destination field focused" />
    </Frame>
  </Step>
  <Step title="Paste the destination">
    ...
    <Frame>
      <img className="block dark:hidden" src="/images/links/composer-destination-light.png" alt="Composer with the destination URL filled in" />
      <img className="hidden dark:block" src="/images/links/composer-destination-dark.png" alt="Composer with the destination URL filled in" />
    </Frame>
  </Step>
  <Step title="Pick a domain and alias (optional)">
    ...
    <Frame>
      <img className="block dark:hidden" src="/images/links/composer-domain-picker-light.png" alt="Domain picker open next to an alias that passed the availability check" />
      <img className="hidden dark:block" src="/images/links/composer-domain-picker-dark.png" alt="Domain picker open next to an alias that passed the availability check" />
    </Frame>
  </Step>
  <Step title="Set expiration (optional)">
    ...
    <Frame>
      <img className="block dark:hidden" src="/images/links/composer-expiration-light.png" alt="Expiration date picker open with a max clicks budget set" />
      <img className="hidden dark:block" src="/images/links/composer-expiration-dark.png" alt="Expiration date picker open with a max clicks budget set" />
    </Frame>
  </Step>
  ...
  <Step title="Create">
    ...
    <Frame>
      <img className="block dark:hidden" src="/images/links/composer-created-light.png" alt="The new link at the top of the links list, active and created just now" />
      <img className="hidden dark:block" src="/images/links/composer-created-dark.png" alt="The new link at the top of the links list, active and created just now" />
    </Frame>
  </Step>
</Steps>
