...
<Frame>
  <img className="block dark:hidden" src="/images/links/password-prompt-light.png" alt="Password prompt shown to a visitor" />
  <img className="hidden dark:block" src="/images/links/password-prompt-dark.png" alt="Password prompt shown to a visitor" />
</Frame>
